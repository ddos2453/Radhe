...
AUTHORIZED_USERS = [5904877352, 1838486266]
...
def start(message):
 ...
 #       types.KeyboardButton('/Show_user_commands'),
  #      types.KeyboardButton('/Show_all_approved_users')
    ...
    bot.send_message(message.chat.id, "👋𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙏𝙤 ŘªĐĤƐ 𝘽𝙤𝙩🗿:", reply_markup=markup)
 #   if user_id not in AUTHORIZED_USERS:
        #bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @radhe2206")
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @radhe2206")
...
if __name__ == "__main__":
    ...
    try:
        ...
        time.sleep(15)  # Wait before restartingme.sleep(15)  # Wait before restarting